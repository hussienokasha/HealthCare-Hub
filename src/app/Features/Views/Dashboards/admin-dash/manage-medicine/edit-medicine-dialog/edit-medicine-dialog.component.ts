...
export class EditMedicineDialogComponent {
  ...
  onSubmitForm() {
    ...
    formData.append('Description', this.editMedicineformGroup.value.description);
    formData.append('Price', this.editMedicineformGroup.value.price);
    formData.append('SideEffects', this.editMedicineformGroup.value.sideEffects);
    formData.append('Ingredients', this.editMedicineformGroup.value.ingredients);
